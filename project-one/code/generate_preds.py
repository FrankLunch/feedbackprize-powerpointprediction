...
if ("v3" in args.save_name)|("v2" in args.save_name):
    ...
    transformers_path = Path("C:/Users/Tony/AppData/Local/Packages/PythonSoftwareFoundation.Python.3.10_qbz5n2kfra8p0/LocalCache/local-packages/Python310/site-packages/transformers")
...
print("Hello, World!")
   ...
   # p=mp.Pool(NUM_CORES)
ner_test_rows = map(generate_text_for_file, test_files)
